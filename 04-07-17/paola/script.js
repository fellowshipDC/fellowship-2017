            ...
            items:                      [
                                            {
                                                ...
                                                title: 'Yoda',      // element title
                                                customData: { favorite: false }    // custom data -> favorite status
                                            },
                                            { src: 'berlin2t.jpg', srct: 'berlin2t.jpg', title: 'Rancor', customData: { favorite: true} },
                                            { src: 'berlin3t.jpg', srct: 'berlin3t.jpg', title: 'Ortolanos', customData: { favorite: false} }
                                        ],
            thumbnailWidth:             'auto',
            thumbnailHeight:            200,
            locationHash:               false,
